// File: A1-Task4-S21-20230440-20230560-20231088.zip
...
#include "A1-Task4-S21-20230440-20230560-20231088-CPU.h"
...
int main() {
    ...
    while(true) {
        ...
        if (choice == 1) {
            ...
            // the user wants to dispay the details of the instructions
        } else if (choice == 2) {
            displayInstructions();
            continue;
